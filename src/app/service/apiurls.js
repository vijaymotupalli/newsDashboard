...
export const UPLOAD_VIDEO_URL = 'http://localhost:9000/api/uploadvideo';
export const UPLOAD_IMAGE_URL = 'http://codeuniverse.in:9000/api/uploadlogo';
export const POST_VIDEO_URL = 'api/news';
export const EDIT_VIDEO_URL = 'api/news';
